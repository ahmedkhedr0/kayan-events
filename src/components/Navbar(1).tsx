        ...
        <div className="bg-gradient-to-r from-amber-500 via-amber-600 to-indigo-700 text-slate-950 text-[11px] sm:text-xs py-1.5 px-3 sm:px-4 font-bold flex justify-between items-center gap-2">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            <button
              ...
              className="bg-amber-500 hover:bg-amber-400 text-slate-950 px-2 py-0.5 rounded-full text-[10px] sm:text-[11px] flex items-center gap-1 font-black transition shadow-sm active:scale-95 shrink-0"
              title="تثبيت المنظومة كتطبيق هاتف مستقل بدون متصفح"
            >
